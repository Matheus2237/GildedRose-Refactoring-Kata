...
#    Given An inventory system managing item quality and sellIn
  ...
  Scenario Outline: Item quality and sellIn update correctly
    ...
    Examples:
      ...
      # Normal items: degrade in quality by 1 per day before sell-in date
      # - After the sell-in date, quality decreases by 2 per day
      # - Quality never goes below 0
      ...
      # Backstage passes: increase in quality as sell-in date approaches
